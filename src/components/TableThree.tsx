...
const PackageItem: React.FC<any> = ({
  ...
  return (
    <tr className="border-b border-[#eee] dark:border-strokedark">
      ...
      <td className="py-5 px-4 dark:text-white">{city}</td>
      <td className="py-5 px-4 dark:text-white">{reportDate}</td>
      <td
        className={`py-2 px-4 dark:text-white ${getcurrentStatusClass()} inline-flex rounded-full px-5 text-sm font-medium my-7`}
      >
        {currentStatus}
      </td>
