...
const FakeNumberChecker = () => {
  ...
  return (
    <div style={{ textAlign: 'center', marginTop: '50px', fontFamily: 'Arial, sans-serif' }}>
      <h1 style={{ fontSize: '2em', marginBottom: '20px', color: '#333' }}>Fake Bank Account Checker</h1>
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <div style={{ maxWidth: '300px', margin: '20px', borderRadius: '8px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }}>
          <Image
            src={fakeNumberImage}
            alt="RBI guidelines"
            width={1920}
        ...
        {isFake !== null && (
          <p style={{ marginTop: '20px', fontSize: '1.2em', color: isFake ? 'red' : 'green' }}>
